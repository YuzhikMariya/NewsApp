...
function loadSources(){
  const url = 'https://newsapi.org/v2/sources?apiKey=0fde136241d74a0487869f4cf6c9a837';
...
function loadBy(urlPart){
  hide('#error-block');
  const url = 'https://newsapi.org/v2/' + urlPart + 'apiKey=0fde136241d74a0487869f4cf6c9a837';
  const request = new Request(url);
  fetch(request)
    .then(function(response) { return response.json(); })
    .then(function(data) {  
